...
//   try{
//     console.log("hey it is starting of delete");
...
//       if (isEdit) {
//         await handleDeleteforEdit(vehicleToEdit.id); // Ensure deletion completes before adding the new vehicle
//       }
...
//   }
// };
//   console.log("it is end of Delete function");
//   }
//   catch(error)
//   {
//     console.log('Error ',error);
...
const handleDeleteforEdit = async (vehicleId) => {
  ...
  //   if (Object.keys(newErrors).length === 0) {
  //     try {
  //     console.log("begining of add fucntion");
  //       const response = await axios.get(`http://localhost:3001/scenarios/${selectedScenario}`);
  //       const scenario = response.data;
  ...
  //     } else {
  //       idToAdd = vehicleToEdit.id;
  //       await handleDeleteforEdit(vehicleToEdit.id);
  //     }
  ...
  //       await axios.put(`http://localhost:3001/scenarios/${selectedScenario}`, scenario);
  //       console.log("end of add fucntion");
  //       navigate('/');
  //     } catch (error) {
  //       console.error('Error adding vehicle:', error);
  //     }
  ...
  //       console.log("Updated scenario with new vehicle:", scenario);
  ...
  const handleAddVehicle = async () => {
    ...
    if (Object.keys(newErrors).length === 0) {
      try {
        ...
        const updatedVehicles = scenario.vehicles.map(vehicle => vehicle.id === idToAdd ? newVehicle : vehicle); // Update existing vehicle or add new one
